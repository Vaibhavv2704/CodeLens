# Sample run 3: Malicious source path blocked
...
{"type": "tool_failed", "data": {"tool": "test_runner", "attempt": 0, "category": "security_block", "error": "Unsafe repository path rejected"}}
{"type": "recovery_started", "data": {"tool": "test_runner", "category": "security_block", "action": "fallback", "observation": "Continue with available static evidence; do not bypass security policy"}}
...
```json
{
  ...
  "tests": {
    ...
    "failed": 0,
    "duration": 0,
    "error_summary": "Unsafe repository path rejected"
  },
  "tools_used": [
    "github",
    "repository",
  ...
  "limitations": [
    "test_runner: Unsafe repository path rejected. Fallback: continue with available static evidence.",
    "Continue with static analysis and evidence verification",
    "Test coverage: Unsafe repository path rejected",
